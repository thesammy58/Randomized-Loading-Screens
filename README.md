# sims3-loading-screen-randomizer
ASI mod that randomizes your loading screen before each startup. Designed to require as little configuration and brain power from the player as I could possibly manage. Just drag-and-drop the ASI file and MyLoadingScreens folder to your Program Files\EA Games\The Sims 3\Game\Bin directory.
